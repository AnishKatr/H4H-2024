  ...
  return (
    ...
    <div className="flex flex-col px-8 bg-sky-950 float-right text-center w-3/12 space-y-4 relative">
      ...
      <div
        ...
        className="dropdown text-sky-100 relative bg-sky-700 justify-center "
      >
        ...
        {isOpen && (
          <div className="absolute inset-x-0">
            <div
              ...
              className="allDiseases option text-sky-100 z-10 bg-sky-600"
            >
              All Diseases
            </div>
            <div
        ...
        <div className="h-64 bg-sky-700 text-sky-100 overflow-auto ">
          {selectedOption === "All Diseases" && (
            <div className="text-xs ">
              <div>
                An infection is the invasion of tissues by pathogens, their
                multiplication, and the reaction of host tissues to the
                infectious agent and the toxins they produce. An infectious
                disease, also known as a transmissible disease or communicable
                disease, is an illness resulting from an infection.
              </div>
              <div>
                Infections can be caused by a wide range of pathogens, most
                prominently bacteria and viruses. Hosts can fight infections
                using their immune systems. Mammalian hosts react to infections
                with an innate response, often involving inflammation, followed
                by an adaptive response.
              </div>
              <div>
                Specific medications used to treat infections include
                antibiotics, antivirals, antifungals, antiprotozoals, and
                antihelminthics. Infectious diseases resulted in 9.2 million
                deaths in 2013 which is about 17% of all deaths. The branch of
                medicine that focuses on infections is referred to as infectious
                diseases.
              </div>
              <div>
                {" "}
                Source -{" "}
                <a href="https://en.wikipedia.org/wiki/Infection">Wikipedia</a>
              </div>
            </div>
          )}
          {selectedOption === "COVID-19" && (
            <div className="text-xs ">
              <div>
                ...
                caused by the virus SARS-CoV-2. The first known case was
              ...
              <div>
                ...
                particles containing the virus can remain suspended in the air
                and travel over longer distances, particularly indoors.
                Transmission can also occur when people touch their eyes, nose
                or mouth after touching surfaces or objects that have been
                contaminated by the virus. People remain contagious for up to 20
                days and can spread the virus even if they do not develop
                symptoms.
              </div>
              <div>
                Source -{" "}
                <a href="https://en.wikipedia.org/wiki/COVID-19">Wikipedia</a>
              </div>
            </div>
          )}
          {selectedOption === "Influenza" && (
            <div className="text-xs ">
              <div>
                Influenza, commonly known as "the flu" or just "flu", is an
                infectious disease caused by influenza viruses. Symptoms range
                from mild to severe and often include fever, runny nose, sore
                throat, muscle pain, headache, coughing, and fatigue. These
                symptoms begin from one to four days after exposure to the virus
                which is typically two days and last for about 2–8 days.
                Diarrhea and vomiting can occur, particularly in children.
                Influenza may progress to pneumonia, which can be caused by the
                virus or by a subsequent bacterial infection. Other
                complications of infection include acute respiratory distress
                syndrome, meningitis, encephalitis, and worsening of
                pre-existing health problems such as asthma and cardiovascular
                disease.
              </div>
              <div>
                There are four types of influenza virus: A, B, C, and D. Aquatic
                birds are the primary source of Influenza A virus or IAV, which
                is also widespread in various mammals, including humans and
                pigs. Influenza B virus or IBV and Influenza C virus or ICV
                primarily infect humans, and Influenza D virus or IDV is found
                in cattle and pigs. IAV and IBV circulate in humans and cause
                seasonal epidemics, and ICV causes a mild infection, primarily
                in children. IDV can infect humans but is not known to cause
                illness. In humans, influenza viruses are primarily transmitted
                through respiratory droplets produced from coughing and
                sneezing. Transmission through aerosols and intermediate objects
                and surfaces contaminated by the virus also occur.
              </div>
              <div>
                Frequent hand washing and covering one's mouth and nose when
                coughing and sneezing reduce transmission. Annual vaccination
                can help to provide protection against influenza. Influenza
                viruses, particularly IAV, evolve quickly, so flu vaccines are
                updated regularly to match which influenza strains are in
                circulation. Vaccines provide protection against IAV subtypes
                H1N1 and H3N2 and one or two IBV subtypes. Influenza infection
                is diagnosed with laboratory methods such as antibody or antigen
                tests and a polymerase chain reaction or PCR to identify viral
                nucleic acid. The disease can be treated with supportive
                measures and, in severe cases, with antiviral drugs such as
                oseltamivir. In healthy individuals, influenza is typically
                self-limiting and rarely fatal, but it can be deadly in
                high-risk groups.
              </div>
              <div>
                Source -{" "}
                <a href="https://en.wikipedia.org/wiki/Influenza">Wikipedia</a>
              </div>
            </div>
          )}
        </div>
