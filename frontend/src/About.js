        ...
        <div>
            ...
            <div className=" flex flex-col justify-center items-center">
                ...
                <p className="text-center p-3">
                    ...
                    for COVID-19 and the Flu. When you hover over one of the
                    cities, its name, latitude and longitude will pop up along
                    under your cursor with its population, number of people
                    affected by each virus respectively shown on the side under
                    the Options on the right side of the screen. Right under
                    there is a Dropbox to select the virus you are interested
                    in, important information about said virus, and a pop up
                    labeled "Symptoms" to verify whether or not you may have it.
                    Under the header, are a few options that you can edit the
                    focus of the map. The height of the Hexagon Bars can be
                    adjusted by choosing "Population," or "Total Disease
                    Numbers" under the "Choose Height Metric." Similarly, you
                    can change the Heatmap Settings to show the severity of each
                    illness under the "Choose Heatmap Metric," with the options
                    "Total Disease Number" or "Population Effected." There is
            ...
            <p className="text-center p-4">
                ...
                <p className="text-center p-5">
                    ...
                    person's ability to become more knowledgable regarding these
                    viruses. After several team meetings, we decided on this
                    interface due to it allowing us to format the information in
                    a way that is easy to interpret, and compact with the
                    inclusion of the right side of the page with the map.
                </p>
                <button
